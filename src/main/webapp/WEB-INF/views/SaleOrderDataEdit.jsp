...
<title>Sale Order Data Edit!!</title>
</head>
<body>
	...
	<div class="container">
		<div class="card">
			<div class="card-heading bg-primary text-white">
				<h1>Welcome To Sale Order Edit</h1>
			</div>
			<!-- CARD HEADING END -->
			<div class="card-body">
				<div class="container">
					<form:form action="update" method="POST" modelAttribute="saleOrder">
						...
						<div class="form-group">
							<form:label path="saleId"
								cssClass="control-label col-sm-offset-4 font-weight-bold">Sale Id</form:label>
							<form:input path="saleId" cssClass="form-control col-sm-4"
								readonly="true" />
						</div>
						...
						<div class="form-group">
							...
							<form:select path="saleCustomers"
								cssClass="form-control col-sm-4">
								<form:option value="">--SELECT--</form:option>
