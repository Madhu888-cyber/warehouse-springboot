...
Having account? <a href="login">Login</a> --%>
	...
	<div class="container">
		<div class="card" style="max-width: 80%;">
			...
			<div class="card-body">
				<form:form method="post" action="saveUser" id="form1"
					modelAttribute="user">
					<div style="max-width: 400px;">
						<div class="form-group">
							<form:label path="userName" class="control-label col-sm-offset-4">
								<b>Username</b>
							</form:label>
						...
						<div class="form-group">
							<form:label path="userEmail"
								class="control-label col-sm-offset-4">
								<b>Email</b>
							</form:label>
							<form:input path="userEmail" type="email" id="txtEmail"
						...
						<div class="form-group">
							<form:label path="password"
								cssClass="control-label col-sm-offset-4">
								<b>Password</b>
							</form:label>
						...
						<div class="form-group">
							<label for="txtConfirmPassword"
								class="control-label col-sm-offset-4"><b>Confirm
									Password</b></label> <input name="txtConfirmPassword" type="password"
						...
						<div class="form-group">
							<form:label path="roles" cssClass="control-label col-sm-offset-4">
								<b>Select Roles</b>
							</form:label>
							...
							<select name="rolesData" multiple="multiple"
