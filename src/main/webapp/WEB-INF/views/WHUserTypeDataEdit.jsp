			...
			<div class="card-body">
				<form:form action="update" method="POST" modelAttribute="whUserType">
					...
					<div class="form-group">
						<form:label path="whUserId"
							cssClass="control-label col-sm-offset-4 font-weight-bold">UserId</form:label>
						<form:input path="whUserId" class="form-control col-sm-4" readonly="true"/>
						<form:errors path="whUserId" cssClass="text-danger"/>
					</div>
					...
					<div class="form-group">
						...
						<form:input path="whUserCode" class="form-control col-sm-4" readonly="true"/>
					...
					<div class="form-group">
						...
						<form:errors path="createdOn" cssClass="text-danger"/>
					</div>
					
					<div class="form-group">
						<form:label path="modeifiedOn"
							cssClass="control-label col-sm-offset-4 font-weight-bold">Modified On</form:label>
						<form:input path="modeifiedOn" cssClass="form-control col-sm-4" />
						<form:errors path="modeifiedOn" cssClass="text-danger"/>
					</div>
