...
public class PurchaseOrderController {
	 ...
	 */
	@PostMapping("/update")
	public String update(@ModelAttribute("po")PurchaseOrder po,BindingResult errors,ModelMap map){
	...
	public String showAddItems(@RequestParam long poId,ModelMap map){
		...
		map.addAttribute("venItems",util.getVendorItems(po.getVendor().getWhUserId()));
		return "AddPoItems";
	}
	...
	public ModelAndView generateInvoice(@RequestParam long poId){
		...
		if(po.getStatus().equals("INVOICED")){
			...
			System.out.println(po.getVendor().getWhUserEmail());
			emailConfig.sendEmail(po.getVendor().getWhUserEmail(), "Invoice", "Download Below Attachment", null);
