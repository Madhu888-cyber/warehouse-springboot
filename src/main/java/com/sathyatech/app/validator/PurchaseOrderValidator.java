...
public class PurchaseOrderValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		else if(po.getShipmentMode() == null || po.getShipmentMode().getShipmentId()==null){
			errors.rejectValue("shipmentMode", "", "Plz Provide ShipmentId");			
		}
			
		if(StringUtils.isEmpty(po.getVendor())){
			errors.rejectValue("vendor", "", "Plz Choose Vendor");
		}
		else if(po.getVendor() == null || po.getVendor().getWhUserId()==null ){
			errors.rejectValue("vendor", "", "Plz Provide Vendor");
		}
